...
/**
 * Created by rportales on 18/05/2017.
 */
...
public class ExtendedApa102 implements AutoCloseable {
    private static final String TAG = "ExtendedApa102";
    ...
    /**
     * Create a new ExtendedApa102 driver.
     *
     ...
     */
    public ExtendedApa102(String spiBusPort, Mode ledMode) throws IOException {
     ...
     */
    public ExtendedApa102(String spiBusPort, Mode ledMode, Direction direction) throws IOException {
        mLedMode = ledMode;
     ...
     */
    @VisibleForTesting
    /*package*/ ExtendedApa102(SpiDevice device, Mode ledMode, Direction direction) throws IOException {
        mLedMode = ledMode;
        mDirection = direction;
        mDevice = device;
        configure(mDevice);
    ...
    public void setBrightness(int ledBrightness) {
        ...
        for (int i=0; i<mLedBrightness.length; i++) {
            mLedBrightness[i] = ledBrightness;
        }
    }
     ...
     */
    public int getBrightness(int pos) {
        return mLedBrightness[pos];
    }
